  ...
  return (
    <div style={baseStyles.container}>
      ...
      <div style={baseStyles.card}>
        ...
        {/* ✅ App Name Included in Title */}
        <h1 style={{ ...baseStyles.textCenter, fontSize: '1.5rem', fontWeight: 600, color: '#1e40af', marginBottom: '0.5rem' }}>
          Depressed Together
        </h1>
        <h2 style={{ ...baseStyles.textCenter, fontSize: '1.25rem', fontWeight: 500, color: '#4b5563', marginBottom: '0.5rem' }}>
          Delete Account
        </h2>
        <p style={{ ...baseStyles.textCenter, color: '#64748b', fontSize: '0.875rem', marginBottom: '1.5rem' }}>
